        ...
        if(subMeet){
            ...
            while(!meet){
                ...
                for(var i = 0; i < toDoList.length; i++){
                    searchPlace(toDoList[i], c); // center를 기준으로 점점 넓은 범위 탐색. meet이 true가 될 때 까지
                    if(result[i] == 0){
                        subMeet = false;
                    }
                }
